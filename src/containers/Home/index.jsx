...
import { AddTransaction, MonthStats, TransactionStats, UserList } from 'components';
...
export function Home() {
  ...
  return <HomeContext.Provider value={{ users, transactions, pointTable, activeUser, handleActiveUserClick }}>
